...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 52ee0490-272d-4cdc-b10f-c857906deca0
```

> `52ee0490-272d-4cdc-b10f-c857906deca0` is the password of the certificate, you can change it to any password you want.
